...
# Inputa cuantitativa mediante cuantitativa (media aleatorizada)
...
# Inputa categórica mediante cuantitativa (la más frecuente aleatorizada)
fillMissCat<- function(data, var1, var2, ncuts){
    dat<- as.data.frame(data)
